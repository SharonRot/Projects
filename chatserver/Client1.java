...
public class Client1 {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		try {
			...
			// remove client
//		    innerMessage.setKey(ChatProtocolKeys.REMOVE_REQUEST);
//		 	innerMessage.setData(null);
//		 	byte[] array3 = ServerMessage.toByteArray(messageToSend);
//			buffer = ByteBuffer.wrap(array3);
//			while (buffer.hasRemaining()) {
//				client.write(buffer);
//			}
//			System.out.println("Tcp client send: " + ServerMessage.toObject(buffer.array()));
